...
class PlayerShip:
    ...
    pressedStatus = {"Left": False, "Right": False, "space": False, "Shift_L": False, "Up":False, "Down":False , "Escape": False}
    ...
    def render(self,canvas:Canvas,dummy1,dummy2,dummy3):
        ...
        if PlayerShip.pressedStatus["Up"]:
            self.y = self.y +1

        if PlayerShip.pressedStatus["Down"]:
            self.y = self.y -1
